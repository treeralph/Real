...
public class CreatePaddle {
    ...
    public Bitmap createPaddle(Bitmap Background, Bitmap Center, Bitmap Handle, int Paddle_Size_x, int rotator){
        // Input : 3 Paddle Bitmap -> Output : 1 Paddlized Bitmap
        ...
        Canvas Canvas_Paddle = new Canvas(Paddle);
        Canvas_Paddle.save();
        Canvas_Paddle.rotate(rotator,Background_Rad,Background_Rad); // rotator
        Canvas_Paddle.translate((float) (Padding*2),0);
    ...
    public Bitmap createPaddle(Bitmap Background, Bitmap Center, Bitmap Handle, int Paddle_Size_x, int rotator, int extra){
        // Input : 3 Paddle Bitmap -> Output : 1 Paddlized Bitmap
        ...
        Bitmap Paddle = Bitmap.createBitmap(Paddle_Size_x+6*Padding,
                (int) (Paddle_Size_x*display_ratio+4*Padding), Bitmap.Config.ARGB_8888);
        Paddle = addPaddingTopForBitmap(Paddle,extra);
        Paddle = addPaddingBottomForBitmap(Paddle,extra);
        Paddle = addPaddingLeftForBitmap(Paddle,extra);
        Paddle = addPaddingRightForBitmap(Paddle,extra);
        Rect Rect_Paddle = new Rect(0,0,Paddle_Size_x+2*Padding, (int) (Paddle_Size_x*display_ratio)+2*Padding);
        final int color = 0xff424242;
        ...
        Canvas_Paddle.save();
        Canvas_Paddle.translate((float) (Padding*2),0);
        Canvas_Paddle.translate(extra,extra);
        Canvas_Paddle.rotate(rotator,Background_Rad,Background_Rad);// rotator
        ...
        // Create Litte Bigger one

        Bitmap Original_Paddle = Bitmap.createBitmap(Paddle,0,0,Paddle.getWidth(),Paddle.getHeight());
        Rect Rect_Original = new Rect(0,0,Original_Paddle.getWidth(),Original_Paddle.getHeight());
        Canvas Canvas_Padded = new Canvas(Original_Paddle);
        Paint Paint_Original_Rect = new Paint();
        Paint_Original_Rect.setStyle(Paint.Style.STROKE);
        Paint_Original_Rect.setStrokeWidth(15);
        Paint_Original_Rect.setColor(Color.RED);
        Canvas_Padded.drawRect(Rect_Original,Paint_Original_Rect);


        Path Path_Original_Background = Path_Background_Stroke;
        Path_Original_Background.offset(2*Padding,0);
        Path_Original_Background.offset(extra,extra);



        // rotate path from centerdot
        Matrix matrix = new Matrix();
        matrix.setRotate(rotator,Background_Rad+extra+2*Padding,Background_Rad+extra);
        Path_Original_Background.transform(matrix);

        // scale path from centerdot
        Matrix matrix1 = new Matrix();
        matrix1.setScale(1.03f,1.03f,Background_Rad+extra+2*Padding,Background_Rad+extra);
        Path_Original_Background.transform(matrix1);
        ...
        // YOU CAN DO SOMETHING TO BACKPATH HERE
        //Canvas_Padded.drawPath(Path_Original_Background,Paint_Original_Rect);
        ...
        paintSimple.setStrokeWidth(20f);
        ...
        paintBlur.setStrokeWidth(60f);
        paintBlur.setMaskFilter(new BlurMaskFilter(25, BlurMaskFilter.Blur.NORMAL));
        ...
        //Canvas_Padded.drawPath(Path_Original_Background,paintSimple);
        Canvas_Padded.drawPath(Path_Original_Background,paintBlur);
        Bitmap Padded_Paddle = Original_Paddle;
        /*
        Padded_Paddle = addPaddingTopForBitmap(Padded_Paddle,100);
        Padded_Paddle = addPaddingBottomForBitmap(Padded_Paddle,100);
        Padded_Paddle = addPaddingLeftForBitmap(Padded_Paddle,100);
        Padded_Paddle = addPaddingRightForBitmap(Padded_Paddle,100);

         */


        return Padded_Paddle;
    }
