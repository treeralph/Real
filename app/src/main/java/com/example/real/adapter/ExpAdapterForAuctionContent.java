...
public class ExpAdapterForAuctionContent extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ExpAdapterForAuctionContent(List<Item> data) {
        this.data = data;
    }

    public ExpAdapterForAuctionContent(List<Item> data, Context context, String contentid) {
        this.data = data;
